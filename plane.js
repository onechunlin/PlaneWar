    ...
    function collision(enemy){
        nowBullet.forEach((item,index) => {
            ...
            let enemyW = enemy.width,
                enemyH = enemy.height;
            let codition =  bulletL + bulletW > enemyL &&
        ...
        nowEnemy.forEach((item) => {
            if(!item.dead){
                ...
                if(codition){//己方飞机和敌方飞机相撞
                    ...
                    game.onmousemove = null;
                    //替换爆炸图片
                    myPlane.src = "image/bz.gif";
                    setTimeout(() => {
                        myPlane.src = "image/my.gif"
